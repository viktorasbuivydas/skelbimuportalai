@props([
    'title' => 'Turite įmonę?',
    'description' => 'Registruokite savo įmonę nemokamai ir būkite matomi tūkstančiams potencialių klientų visoje Lietuvoje.',
])

<section class="bg-gradient-to-br from-indigo-600 to-indigo-800">
