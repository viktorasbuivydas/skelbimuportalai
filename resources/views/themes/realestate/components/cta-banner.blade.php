@props([
    'title' => 'Parduodate nekilnojamąjį turtą?',
    'description' => 'Pasiekite tūkstančius pirkėjų. Įkelkite skelbimą nemokamai ir parduokite greičiau.',
])

<section class="bg-gradient-to-br from-emerald-600 to-green-700">
